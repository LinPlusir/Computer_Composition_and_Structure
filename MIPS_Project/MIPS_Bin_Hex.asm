.data
    ...
    show_hex:  .asciiz  "\nHexdecimal:\n"
    string_not:  .asciiz "-"
    string_one_dot: .asciiz "1."
    string_binary:   .asciiz  "*2^"
    string_hex: .asciiz "*16^"
    string_dot: .asciiz "."
.text
...
hexbegin:   
    ...
    zhengshuhex:
    addi $t3,$t5,-127
    bltz $t3, less_than_zero
    #t3>=0
    andi $t7,$t3,0x3    # $t7 = $t3 mod 4
    srl $t8,$t3,2       # $t8 = $t3 / 4
    j HexEnd
    ...
    hexoutLoop:
    andi  $t3,$t1,0x3  # $t3 = $t1 mod 4
    beqz $t3,hexoutLoopEnd
    addi $t1,$t1,-1
    addi $t7,$t7,1
    j hexoutLoop
...
# void toHex(a0 content, a1 flag) 转换成16进制
